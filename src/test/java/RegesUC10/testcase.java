...
import userregestration.UserRegesUC10;

public class testcase {

    UserRegesUC10 user = new UserRegesUC10();
    ;

    @Test
    public void FirstName_ShouldReturnTrue_LetterShouldbeUpperCase()
    {
        boolean result = user.validateFirstName("Tanmay");
        Assert.assertTrue(result);
    }
    @Test
    public void ShouldReturnFalse_LetterShouldLessthanThreeChar()
    {
        boolean result = user.validateFirstName("Ta");
    ...
    {
        boolean result = user.validateLastName("MAllick");
        Assert.assertFalse(result);
    }
    ...
    {
        boolean result = user.validateFirstName("Kumar^Mallick");
        Assert.assertFalse(result);
    }
    @Test
