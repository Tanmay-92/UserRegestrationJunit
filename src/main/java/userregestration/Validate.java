...
public class Validate {
    ...
    private UserRegesUC10 userRegistration;
    private boolean expectedResult;
    private String emailId;
    public Validate(String emailId, boolean expectedResult)
    {
        super();
    ...
    {
        userRegesUC10 = new UserRegesUC10();
    }
    ...
    {
        boolean result = userRegistration.validate(emailId);
        Assert.assertEquals(this.expectedResult, userRegistration.validate(emailId));
    }
}
